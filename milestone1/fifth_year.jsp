				...
				try {
					...
					try {
						if (action != null && action.equals("insert")) {
							...
							// INSERT the 5thyear attributes INTO the 5thyear table.
							...
							//update 5thyear table
							PreparedStatement pstmt_fifth_year = conn.prepareStatement(
									"INSERT INTO fifth_year(student_id, college, major, minor, department) " +
											"VALUES (?, ?, ?, ?, ?)");

							pstmt_fifth_year.setString(1, request.getParameter("student_id"));
							pstmt_fifth_year.setString(2, request.getParameter("college"));
							pstmt_fifth_year.setString(3, request.getParameter("major"));
							pstmt_fifth_year.setString(4, request.getParameter("minor"));
							pstmt_fifth_year.setString(5, request.getParameter("department"));
							pstmt_fifth_year.executeUpdate();
					...
					String sql ="SELECT student.student_id,first_name,middle_name, last_name, ssn, " +
							"is_enrolled, residency, college, major, minor, department " +
							"FROM student INNER JOIN fifth_year ON student.student_id = fifth_year.student_id;";
					...
					%>
						<tr>
							<form action="fifth_year.jsp" method="get">
