				...
				try {
					...
					try {
						if (action != null && action.equals("insert")) {
							...
							// INSERT the master attributes INTO the master table.
							...
							//update master table
							PreparedStatement pstmt_master = conn.prepareStatement(
									"INSERT INTO master(student_id) " +
											"VALUES (?)");

							pstmt_master.setString(1, request.getParameter("student_id"));
							pstmt_master.executeUpdate();
					...
					String sql ="SELECT student.student_id,first_name,middle_name, last_name, ssn, is_enrolled, residency, department FROM student INNER JOIN graduate ON student.student_id = graduate.student_id INNER JOIN master ON master.student_id = graduate.student_id;";
					...
					%>
						<tr>
							<form action="master.jsp" method="get">
